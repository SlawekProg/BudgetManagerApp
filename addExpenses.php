                                    ...
                                    <form class="mx-1 mx-md-4" method="post">
                                        ...
                                        <div class="mb-4">
                                            <div class="input-group ">
                                                ...
                                                <select class="custom-select form-control border-start-0" id="inputGroupSelect02" name="expense_type">
                                                <option value="" selected disabled hidden>Wybierz rodzaj wydatku</option>
                                                <?php load_expense_type_fromDB();?>
                                                </select>
                                            </div>
                                            <?php err_entered_expense();?>
                                        </div>
                                        <div class="mb-4">
                                            <div class="input-group">
                                                <span class="input-group-text bg-white border-end-0">
                                                ...
                                                <select class="custom-select form-control border-start-0" name="payment_type">
                                                <option value="" selected disabled hidden>Wybierz rodzaj płatności</option>
                                                <?php load_payment_type_fromDB();?>
                                                </select>
                                            </div>
                                            <?php err_entered_payment();?>
                                        </div>
                                        <div class="mb-4">
                                            <div class="input-group">
                                                <span class="input-group-text bg-white border-end-0">
